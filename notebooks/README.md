...
This should allow you to directly import `src/pix2pix` in your notebook.
...
Run `python -m ipykernel install --user --name="pix2pix"` from within your project environment to allow jupyter
to use your project's virtual environment. Afterwards a new kernel called pix2pix should be available in the
